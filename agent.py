...
class Agent:
    ...
    def train_long_memory(self):
        if len(self.memory) > BATCH_SIZE:
            mini_sample = random.sample(self.memory, BATCH_SIZE) # List of tupple
        else:
...
def train():
    ...
    while True:
        ...
        #train short memory
        agent.train_short_memory(curr_state, final_action, reward,new_state, done)

        #remember
        agent.remember(curr_state, final_action, reward,new_state, done)
